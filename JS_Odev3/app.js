...
categories.forEach((e) => {
	$(".btn-container").append(
		`<button class="btn btn-outline-dark btn-item" data-id="${e}">${e}</button>`
	);
});
...
$(document).on("click", ".btn-item", function (e) {
	...
	let filteredMenu =
		category == "All" ? menu : menu.filter((e) => e.category == category);
...
function addItemToList(element) {
	$(".section-center").append(`<div class="menu-items col-lg-6 col-sm-12">
